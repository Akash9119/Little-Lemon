...
const reviews = [
    {image: images.iqsf, name: "IQSF", reviewText: "Little Lemon wowed us with exquisite flavors, top-notch service, and a cozy atmosphere. Highly recommended!"},
    {image: images.sajal, name: "Sajal", reviewText: "Little Lemon wowed us with exquisite flavors, top-notch service, and a cozy atmosphere. Highly recommended!"},
    {image: images.ramsha, name: "Ramsha", reviewText: "Little Lemon wowed us with exquisite flavors, top-notch service, and a cozy atmosphere. Highly recommended!"},
    {image: images.mawra, name: "Mawra", reviewText: "Little Lemon wowed us with exquisite flavors, top-notch service, and a cozy atmosphere. Highly recommended!"},
]
